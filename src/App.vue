  ...
  <div class="container">
      ...
      <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
          <ul class="navbar-nav ms-auto navbar-nav-scroll">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="#contact">Test</a>
              </li>
              <li class="nav-item">
      ...
      <div class="row">
          ...
          <div class="col-lg-6 col-xl-5">
              <div class="text-container">
                  ...
                  <p class="p-large">I graduated high school on 2016 and pursue Diploma in IT at UTeM for 2 and a half years. After diploma, I decided to pursue my degree in UTeM for another 2 and a half years majoring in Software Development. With a passionate dream and ethusiast in learning STEM I've earned cgpa of 3.67. As a final year student, I am interested to gain experience in your company to enchance my skills.</p>
              </div> 
          </div> 
      </div>
  </div> 
